using MoodlesStatusInfo = (
    ...
    long ExpireTicks,
    KinkLinkCommon.Dependencies.Moodles.Enums.MoodleType Type,
    int Stacks,
    int StackSteps,
    uint Modifiers,
    System.Guid ChainedStatus,
    KinkLinkCommon.Dependencies.Moodles.Enums.MoodleChainTrigger ChainTrigger,
    string Applier,
    string Dispeller,
    bool Permanent);
...
using KinkLinkClient.Dependencies.Moodles.Domain;
