    ...
    SelectionManager selectionManager) : IDrawable
{
    ...
    public void Draw()
    {
        ImGui.BeginChild("CustomizePlusContent", KinkLinkStyle.ContentSize, false, KinkLinkStyle.ContentFlags);

        var width = ImGui.GetWindowWidth();
        var padding = new Vector2(ImGui.GetStyle().WindowPadding.X, 0);

        var begin = ImGui.GetCursorPosY();
        SharedUserInterfaces.ContentBox("ProfileSearch", KinkLinkStyle.PanelBackground, true, () =>
        {
