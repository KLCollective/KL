...
public class WatcherIntegrationTestBase : DatabaseServiceTestBase
{
    ...
    protected WatcherIntegrationTestBase(TestDatabaseFixture fixture)
        : base(fixture)
    {
    ...
    protected Presence CreatePresence(string connectionId = "test-conn-id")
        => new(connectionId, "TestChar", "TestWorld");
}
